...
echo "==> Priming Environment with Standalone Android Command Line Tools..."
export ANDROID_HOME=$HOME/android-sdk
mkdir -p $ANDROID_HOME/cmdline-tools

# Pull down the precise standalone Command Line tools
...
echo "==> Injecting Invisible Universal License Hashes (Rule 4)..."
...
# Sync across directory trees to guarantee the compiler sees it
mkdir -p $ANDROID_HOME/licenses
cp /licenses/android-sdk-license $ANDROID_HOME/licenses/android-sdk-license

echo "==> Registering System Paths..."
...
echo "==> Fetching Platform and Build Elements (Target SDK 36)..."
sdkmanager --sdk_root=$ANDROID_HOME "platform-tools" "platforms;android-36" "build-tools;36.0.0"

echo "==> Adjusting Local Permissions..."
chmod +x gradlew

echo "==> Cloud Environment Successfully Primed!"
